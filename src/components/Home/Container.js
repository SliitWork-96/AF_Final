...
export default class Container extends Component {
  ...
  renderCards() {
    return this.state.category.map(function(object, i) {
      return <Link to={'/description/'+ object._id}>
        <Card  className="mr-4 mb-4 category-card" style={{ width: '18rem' }}>
          <Card.Img variant="top"  src={`http://localhost:5000/${ object.images[0]} `}/>
          <Card.Body>
            <Card.Title className="text-center">{object.EventType}</Card.Title>
          </Card.Body>
        </Card>
      </Link>;
    });
    ...
    return (
      <div>
        ...
        <div className="main-container">
          <h1 className="page-header ml-4">Event Packages</h1>
